...
var config = {
    paths: {
        products_list: 'Creativesteps_CatalogAddon/js/products-list'
    },
    shim: {
        products_list: {
            deps: ['jquery']
    ...
    config: {
        mixins: {
            'Magento_Customer/js/model/authentication-popup': {
                'Creativesteps_CustomerAddon/js/model/authentication-popup-mixin': true
            }
        }
    }
};
...
var config = {
    map: {
        '*': {
            upcaseInputValue: 'Creativesteps_CustomerAddon/js/upcase-input-value'
        }
    }
};
...
var config = {
    map: {
        '*': {
            creativesteps_rma: 'Creativesteps_Rma/js/rma',
        }
    }
};
...
var config = {
    paths: {
        equalHeight: 'Magento_Theme/js/equal-height',
        equalHeightGroup: 'Magento_Theme/js/equal-height-group',
        lightbox2: '//cdn.jsdelivr.net/npm/lightbox2@2.11.3/dist/js/lightbox.min',
        vanillaJsTabs: 'js/vendor/vanilla-js-tabs'
    }
};
